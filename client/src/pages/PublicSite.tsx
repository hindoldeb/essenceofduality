  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {isSectionVisible("album") && (
        <section id="album" className="py-24 px-6 border-t border-gold/20" style={{background:'oklch(0.14 0.018 60)'}}>
      ...
      {isSectionVisible("tracklist") && tracks.length > 0 && (
        <section id="tracklist" className="py-24 px-6 border-t border-gold/20" style={{background:'oklch(0.06 0.005 60)'}}>
      ...
      {/* ── Artist Quote ── */}
      <section className="py-20 px-6 border-t border-gold/20" style={{background:'oklch(0.14 0.018 60)'}}>
      ...
      {isSectionVisible("musicians") && musicians.length > 0 && (
        <section id="musicians" className="py-24 px-6 border-t border-gold/20" style={{background:'oklch(0.06 0.005 60)'}}>
      ...
      {isSectionVisible("gallery") && gallery.length > 0 && (
        <section id="gallery" className="py-24 px-6 border-t border-gold/20" style={{background:'oklch(0.14 0.018 60)'}}>
      ...
      {isSectionVisible("reviews") && reviews.length > 0 && (
        <section id="reviews" className="py-24 px-6 border-t border-gold/20" style={{background:'oklch(0.06 0.005 60)'}}>
          <div className="max-w-5xl mx-auto">
      ...
      {isSectionVisible("ragas") && ragas.length > 0 && (
        <section id="ragas" className="py-24 px-6 border-t border-gold/20" style={{background:'oklch(0.14 0.018 60)'}}>
          <div className="max-w-5xl mx-auto">
      ...
      {isSectionVisible("bio") && (
        <section id="bio" className="py-24 px-6 border-t border-gold/20" style={{background:'oklch(0.06 0.005 60)'}}>
      ...
      {isSectionVisible("tour") && tourDates.length > 0 && (
        <section id="tour" className="py-24 px-6 border-t border-gold/20" style={{background:'oklch(0.14 0.018 60)'}}>
